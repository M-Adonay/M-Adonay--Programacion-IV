        ...
        methods: {
            ...
            obtenerDatos(busqueda=''){
                ...
                data.onsuccess = resp=>{
                    ...
                    this.alumnos = data.result.filter(alumno=>alumno.nombre.toLowerCase().indexOf(busqueda.toLowerCase())>-1 || alumno.codigo.toLowerCase().indexOf(busqueda.toLowerCase())>-1);
                };
                data.onerror = e=>{
