                    ...
                    <div class="row p-1">
                        ...
                        <div class="col col-md-3">
                            ...
                            <input title="Ingrese el aula" v-model="materia.aula"
                                pattern="[A-Za-zñÑáéíóúü .#0-9_]{2,75}" required type="text" class="form-control">
        ...
        methods: {
            ...
            obtenerDatos(busqueda=''){
                ...
                data.onsuccess = resp=>{
                    ...
                    this.materias = data.result.filter(materia=>materia.nombre.toLowerCase().indexOf(busqueda.toLowerCase())>-1 || materia.codigo.toLowerCase().indexOf(busqueda.toLowerCase())>-1);
                };
                data.onerror = e=>{
