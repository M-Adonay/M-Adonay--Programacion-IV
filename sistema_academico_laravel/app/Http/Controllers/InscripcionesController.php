...
class InscripcionesController extends Controller
{
    ...
    {
        return Inscripciones::selectRaw('GROUP_CONCAT(m.nombre) AS materias, GROUP_CONCAT(i.idMateria) AS idMateria, GROUP_CONCAT(i.idMateria) AS codigoMaterias, a.nombre AS alumnos, i.idAlumno')
    ...
    {
        Inscripciones::where('idAlumno', $id)->delete();
